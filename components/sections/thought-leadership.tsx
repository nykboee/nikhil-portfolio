...
export function ThoughtLeadership() {
  return (
    <section id="thought" className="relative mx-auto max-w-7xl px-5 py-24 md:px-8 md:py-32">
      <SectionHeader
        ...
        {thoughtLeadership.map((item, i) => {
          ...
          return (
            <Reveal as="article" key={item.title} delay={(i % 3) * 0.05}>
              <div className="flex h-full flex-col rounded-2xl border border-border bg-card p-6 transition-colors hover:border-primary/40">
